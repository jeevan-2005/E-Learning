...
exports.authorizeRoles = exports.isAuth = void 0;
require("dotenv").config();
const catchAsyncError_middleware_1 = __importDefault(require("./catchAsyncError.middleware"));
const ErrorHandler_1 = __importDefault(require("../utils/ErrorHandler"));
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const redis_1 = require("../utils/redis");
exports.isAuth = (0, catchAsyncError_middleware_1.default)(async (req, res, next) => {
